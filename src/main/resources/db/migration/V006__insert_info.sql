...
insert into questions (title, survey_id)
values ('4. Please rate your knowledge on the following term: Knowledgeable __ __ __ __ __ Inexperienced', 1);
insert into questions (title, survey_id)
values ('5. Please rate our staff on the following term: Professional __ __ __ __ __ Inappropriate', 1);

insert into survey (survey_name)
values ('Test Questionnaire');

insert into questions (title, survey_id)
values ('1. How much time do you spend using facebook? (per day)', 2);
